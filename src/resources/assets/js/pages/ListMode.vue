    ...
    <div class="col-lg-12 w-100 h-50">
      ...
      <div v-if="!loading && $store.state.orders" class="card-body">
        <table class="table">
          ...
          <th>Seleção</th>
          <tbody>
            <tr v-for="order in getResultQuery()" :key="order.order_id">
              ...
              <td class="font-weight-black">
                ...
                <div class="font-weight-medium">
                  Distancia:
                  {{ parseFloat(order.distance).toFixed() / 1000 }} KM
                </div>
              </td>
              <td class="font-weight-black">
                <div class="font-weight-medium">
                ...
                <div
                  ...
                  v-if="!order.prepaid && order.method_payment === 'CASH'"
                >
                  Pagamento: DINHEIRO
                </div>
                <div
                ...
                <div
                  class="font-weight-medium"
                  v-if="!order.prepaid && order.method_payment === 'CREDIT'"
                >
                  Pagamento: MÁQUINA
                </div>
                <div
              ...
              <td>
                <div class="grey--text text-darken-1 ma-2 mt-6">
                  ...
                  >
                    <v-icon color="white" left>mdi-map</v-icon>
                    ACOMPANHAR
                  </v-btn>
                </div>
              </td>
