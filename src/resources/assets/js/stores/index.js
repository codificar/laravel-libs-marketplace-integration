...
const store = new Vuex.Store({
  ...
  actions: {
    ...
    getOrders({ commit }, data, page = 1) {
      ...
      commit("CLEAR_ORDERS");
      axios
        .post("/libs/marketplace-integration/orders/?page=" + page, data)
        .then((res) => {
    ...
    deleteMarketConfig({ dispatch }, marketConfigId) {
      ...
      axios
        .delete(
          "/libs/marketplace-integration/market_config/delete/" + marketConfigId
        )
        .then((res) => {
        ...
        .then((res) => {
          if (res.status == 200) {
            ...
            commit("credentials", {
              ...
              ifood_client_secret: res.data.ifood_client_secret.value,
            });
            // Vue.swal.fire({
            //   title: 'Sucesso!',
            //   text: res.data.message,
